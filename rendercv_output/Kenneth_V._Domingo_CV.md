...
# <<section_title>>
## **University of the Philippines-Diliman**, B.S. in Applied Physics (Major in Instrumentation) -- Quezon City, PH
Aug 2015 – July 2020
...
# <<section_title>>
## **AI Software Engineer**, Eyva -- Cologne, DE (Remote)
...
## **Software Engineer / Data Engineer**, Thinking Machines Data Science -- Taguig City, PH
...
## **Software Developer (Freelance)**, Stevn Books -- Manila, PH (Remote)
...
## **Software Engineer / Data Analyst**, Cobena Business Analytics and Strategy (Demand Science) -- Taguig City, PH
...
## **Backend Developer (Volunteer)**, DetectPH -- Quezon City, PH
...
## **Bioinformatics Intern**, Philippine Genome Center -- Quezon City, PH
...
## **Student Researcher**, Instrumentation Physics Laboratory -- Quezon City, PH
...
## **Student Assistant (Contract)**, Philippine Coral Reef and Mangrove Remote Sensing Project -- Quezon City, PH
...
- **Frontend**: TypeScript, Vite, React, TanStack Start, LibreMaps, Protomaps

- **Infrastructure**: Docker, Kubernetes, Helm, Cloudflare

- **Data**: OpenStreetMaps, Instagram
...
# <<section_title>>
## **BlueCarT: Tracking mangrove blue carbon in the Philippines through an open-access data analytics platform (DAP)**
...
# <<section_title>>
**Backend:** Python (FastAPI, FastMCP, Django, Flask), Go (Fiber), Node.js (Express, Hono, Bun)

**Frontend:** TypeScript (React, TanStack Start, Next.js, Svelte, Astro), UI (Shadcn, TailwindCSS, Vercel AI Elements)

**Databases:** OLTP (PostgreSQL, SQLite, Redis), OLAP (DuckDB, Trino), Warehouse (BigQuery, DuckLake)  Vector (Chroma, Weaviate)

**Cloud Platforms:** Google Cloud Platform, Amazon Web Services, Microsoft Azure, Vercel, Cloudflare

**DevSecOps:** Git, Docker, Kubernetes, Helm, Snyk, ArgoCD, GitHub, GitHub Actions, Azure DevOps, Infisical

**Data:** Dagster, NumPy, (Geo)Pandas, Polars, Delta Lake, DuckLake, Apache Spark

**AI/ML:** Ollama, LM Studio, LangChain, Claude Code, Gemini CLI, Cursor, Vercel AI SDK, TensorFlow, Keras, Scikit-Learn, OpenCV
