...
\begin{document}
    ...
    \section{Work Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Performed the migration of the Eyva platform from standalone React to Next.js, implemented the new design system, and contributed to the platform's continuous improvement.
                \item Redeveloped the Research Assistant, allowing it to integrate better with the Eyva platform, implementing an agentic architecture, overhauling the chat interface to align with the new design system, and making it compliant with the ISO 27001:2022 standard.
                \item Member of the Information Security Management System (ISMS) team and owned major tasks contributing to the ISO 27001:2022 certification process.

                \item Owned routine security, compliance, infrastructure maintenance, and system administration tasks.
                \item Created proof-of-concepts for adopting new vendors such as centralized logging and notification systems.
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Projects}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item \textbf{Frontend}: TypeScript, React, Next.js, T3, tRPC, Prisma, Auth.js, Zustand, TailwindCSS, Shadcn UI
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item \href{https://sdg-tool.goldstandard.org}{Web application} developed for Gold Standard to digitize their process of  reporting, validating, verifying, and tracking the contribution of project activities to the UN Sustainable  Development Goals.
                ...
                \item \textbf{DevOps}: GitHub, GitHub Actions, GCP Cloud Build, Terraform
                \item \textbf{Infrastructure}: GCP Cloud Run, GCP Cloud SQL, Auth0
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item \textbf{DevOps}: GitHub, GitHub Actions, Terraform
                \item \textbf{Infrastructure}: Docker, AWS EC2, AWS ECS, Cloudflare
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item A \href{https://hannibot.kvd.studio}{Discord bot} that keeps track of upcoming K-pop releases, and crossposts  Twitter and VLIVE media to K-pop-oriented Discord guilds (\href{https://github.com/kvdomingo/chaebot}{GitHub}).
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item A geospatial \href{https://banyuh.ai}{web app} to allow users within Metro Manila to locate nearby  restrooms with bidets (\href{https://github.com/kvdomingo/banyuhay}{GitHub}).
    ...
    \section{Publications}
        ...
        \begin{samepage}
            \begin{twocolentry}{
                ...
                \textbf{BlueCarT: Tracking mangrove blue carbon in the Philippines through an open-access data analytics platform (DAP)
        }

                \vspace{0.10 cm}

                \mbox{D. C. M. Bajaro}, \mbox{K. V. Domingo}, \mbox{S. P. B. Manalo}, \mbox{P. B. Jacob}, \mbox{A. A. Nierves}, \mbox{C. D. C. Zablan}, \mbox{A. C. Balota}, \mbox{M. E. B. Gerona-Daga}, \mbox{D. T. Gevana}, \mbox{S. G. Salmo III}
            \end{twocolentry}
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Cloud Platforms:} Google Cloud Platform, Amazon Web Services, Microsoft Azure, Vercel, Cloudflare
        ...
        \begin{onecolentry}
            \textbf{Data:} Dagster, NumPy, (Geo)Pandas, Polars, Delta Lake, DuckLake, Apache Spark
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{AI/ML:} Ollama, LangChain, Claude Code, Gemini CLI, Cursor, Vercel AI SDK, TensorFlow, Keras, Scikit-Learn, OpenCV
        ...
        \begin{onecolentry}
            \textbf{Business Intelligence/Dashboarding:} Apache Superset, Metabase, Evidence
        \end{onecolentry}
